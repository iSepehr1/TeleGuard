...
local bot_id = our_id -- your bot id
   -- like local bot_id = 1234567
    ...
    elseif msg.action.type == "chat_add_user" and msg.action.user.id == tonumber(bot_id) and not is_sudo(msg) then
       send_large_msg("chat#id"..msg.to.id, 'Zart  Pool Nadari Group Bekhari? Heh.. Khob Kir Shodi Be Ja In Kos Kalak Bazia Bia Group Daemi Bekhar Bye :)   Admin: @iSepehr2001', ok_cb, false)
       chat_del_user("chat#id"..msg.to.id, 'user#id'..bot_id, ok_cb, false)
    end
end
